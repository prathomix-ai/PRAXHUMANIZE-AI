...
export default function DashboardShell({
  ...
  const userFirstName = email ? email.split("@")[0] : "Creator";
      ...
      <header className="sticky top-0 z-30 flex items-center justify-between border-b border-white/10 bg-[#070714]/80 backdrop-blur-xl px-4 py-3 md:hidden">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="flex items-center gap-1.5 rounded-xl bg-gradient-to-r from-aurora-violet to-aurora-blue px-3 py-1.5 text-xs font-semibold text-white shadow-md"
          >
            <Plus size={15} /> New
          </button>
          ...
          <button
            ...
            className="flex h-9 w-9 items-center justify-center rounded-xl glass text-slate-300"
          >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            ...
            <div className="relative overflow-hidden rounded-3xl glass border border-white/10 bg-[radial-gradient(ellipse_at_top_left,rgba(139,92,246,0.15),transparent_70%)] bg-slate-950/80 p-6 backdrop-blur-xl shadow-xl transition-all hover:border-aurora-violet/30">
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-bold uppercase tracking-wider text-slate-400">Words Humanized</span>
              ...
              <div className="flex items-baseline gap-2">
                <span className="font-display text-3xl font-extrabold text-white">12,450</span>
                <span className="text-xs font-semibold text-emerald-400 flex items-center gap-0.5">
                  <TrendingUp size={12} /> +18%
                </span>
              </div>
              <p className="mt-2 text-[11px] text-slate-400">Total words converted to 100% human score</p>
            </div>
            ...
            <div className="relative overflow-hidden rounded-3xl glass border border-white/10 bg-[radial-gradient(ellipse_at_top_left,rgba(59,130,246,0.15),transparent_70%)] bg-slate-950/80 p-6 backdrop-blur-xl shadow-xl transition-all hover:border-aurora-blue/30">
              <div className="flex items-center justify-between mb-3">
                <span className="text-xs font-bold uppercase tracking-wider text-slate-400">AI Detectors Bypassed</span>
              ...
              <div className="flex items-baseline gap-2">
                <span className="font-display text-3xl font-extrabold text-white">34</span>
                <span className="text-xs font-semibold text-aurora-mint">100% Success</span>
              </div>
              <p className="mt-2 text-[11px] text-slate-400">Bypasses Turnitin, Originality.ai & GPTZero</p>
            </div>
            ...
            <div className="relative overflow-hidden rounded-3xl glass border border-white/10 bg-[radial-gradient(ellipse_at_top_left,rgba(236,72,153,0.15),transparent_70%)] bg-slate-950/80 p-6 backdrop-blur-xl shadow-xl transition-all hover:border-aurora-rose/30 flex flex-col justify-between">
              <div>
                ...
                <div className="flex items-center gap-2">
                  <span className="font-display text-2xl font-extrabold text-white">{credits} Credits Left</span>
                </div>
              </div>
              <div className="mt-4 flex items-center justify-between pt-3 border-t border-white/5">
                <span className="text-[11px] text-slate-400">Unlimited Monthly Refills</span>
                <button
                  onClick={() => setIsModalOpen(true)}
                  className="rounded-xl glass border border-white/20 px-3 py-1.5 text-xs font-semibold text-white hover:bg-white/10 transition-colors"
                >
                  Manage Plan
                </button>
              </div>
          ...
          <div className="rounded-3xl glass border border-white/10 bg-slate-950/50 p-5 backdrop-blur-xl shadow-xl space-y-3">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              ...
              >
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-200 group-hover:text-white">Humanize Essay</h4>
              ...
              >
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-200 group-hover:text-white">Bypass Turnitin</h4>
              ...
              >
                ...
                <div>
                  <h4 className="text-xs font-bold text-slate-200 group-hover:text-white">Write Email</h4>
            ...
            >
              ...
              <div className="flex items-center justify-between pb-6 border-b border-white/10">
                ...
                <button
                  ...
                  className="flex h-9 w-9 items-center justify-center rounded-xl glass text-slate-400 hover:text-white hover:bg-white/10 transition-colors"
                >
                  <X size={18} />
                </button>
              </div>
